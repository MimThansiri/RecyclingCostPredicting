...
# Fill missing values for the year 2024 with the last available value
last_export_value = merged_data['export'].dropna().iloc[-1]
merged_data.loc[merged_data['update_date'].dt.year == 2024, 'export'] = last_export_value
